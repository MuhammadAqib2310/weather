...
function mapHourly(items, timezoneOffset = 0) {
...
function mapDaily(items, timezoneOffset = 0) {
...
export async function getWeatherByCity(city) {
    ...
    if (cached)
        return { ...cached, provider: { ...cached.provider, cached: true } };
